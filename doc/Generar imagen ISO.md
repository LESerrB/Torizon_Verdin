...
![Comprobación del contenedor](./img/dck_rgt.png)

Obtener la dirección IP del contenedor.

    ip addr show docker0 | grep inet

![Comprobación del contenedor](./img/IP_addressdck.png)
